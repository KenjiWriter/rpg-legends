...
@section('title', 'Brońmistrz')

@section('content')
    <div class="rpgui-container framed-golden-2" style="padding:30px; max-width:800px; margin:auto;">
        <h2 class="section-title" style="text-align:center;">🔧 Brońmistrz</h2>
        <p style="text-align:center;">Tutaj możesz kupić lub ulepszyć broń dla swojej postaci.</p>
